...
const smoke_specs = [_][]const u8{
    ...
    "benchmarks/specs/interop/satoshi-lm-safetensors-export-synthetic.json",
    "benchmarks/specs/interop/satoshi-lm-safetensors-import-synthetic.json",
    "benchmarks/specs/interop/corridor-control-safetensors-export-synthetic.json",
    "benchmarks/specs/interop/corridor-control-safetensors-import-synthetic.json",
    "benchmarks/specs/interop/dqn-cartpole-safetensors-export-synthetic.json",
    "benchmarks/specs/interop/dqn-cartpole-safetensors-import-synthetic.json",
    "benchmarks/specs/interop/gcn-safetensors-export-synthetic.json",
    "benchmarks/specs/interop/gcn-safetensors-import-synthetic.json",
    "benchmarks/specs/interop/mnist-mlp-safetensors-export-synthetic.json",
    "benchmarks/specs/interop/mnist-mlp-safetensors-import-synthetic.json",
    "benchmarks/specs/interop/pendulum-dynamics-safetensors-export-synthetic.json",
    "benchmarks/specs/interop/pendulum-dynamics-safetensors-import-synthetic.json",
    "benchmarks/specs/model-train/mnist-mlp-synthetic.json",
    "benchmarks/specs/model-infer/mnist-mlp-synthetic.json",
    "benchmarks/specs/model-train/satoshi-lm-synthetic.json",
    "benchmarks/specs/model-infer/satoshi-lm-synthetic.json",
