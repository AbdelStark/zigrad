...
pub const device = struct {
    ...
    pub const HostDispatchTelemetry = device_root.HostDispatchTelemetry;
    pub const HostThreadEnv = device_root.HostThreadEnv;
    pub const HostBmmDispatchMode = device_root.HostBmmDispatchMode;
    pub const HostRuntimeDiagnostics = device_root.HostRuntimeDiagnostics;
    pub const HostDiagnosticsFormatOptions = device_root.HostDiagnosticsFormatOptions;
    pub const RuntimeDeviceKind = device_root.RuntimeDeviceKind;
    pub const RuntimeDeviceRequest = device_root.RuntimeDeviceRequest;
    pub const RuntimeDeviceSupport = device_root.RuntimeDeviceSupport;
    pub const RuntimeDeviceDiagnosticsOptions = device_root.RuntimeDeviceDiagnosticsOptions;
    pub const RuntimeDevice = device_root.RuntimeDevice;
    pub const CudaDevice = device_root.CudaDevice;
    pub const CudaRuntimeDiagnostics = device_root.CudaRuntimeDiagnostics;
    pub const CudaDiagnosticsFormatOptions = device_root.CudaDiagnosticsFormatOptions;
    ...
    pub const configuredRuntimeDiagnostics = device_root.configuredRuntimeDiagnostics;
    pub const writeConfiguredRuntimeDiagnostics = device_root.writeConfiguredRuntimeDiagnostics;
    pub const maybeWriteConfiguredRuntimeDiagnostics = device_root.maybeWriteConfiguredRuntimeDiagnostics;
    pub const hostDiagnosticsEnabled = device_root.hostDiagnosticsEnabled;
    pub const parseRuntimeDeviceRequest = device_root.parseRuntimeDeviceRequest;
    pub const resolveRuntimeDeviceRequest = device_root.resolveRuntimeDeviceRequest;
    pub const initRuntimeDevice = device_root.initRuntimeDevice;
};
